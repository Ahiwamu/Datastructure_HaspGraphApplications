...
public class JavaCollectionTest {
    ...
    public static void linkedlistTest(){
        ...
        if(list.indexOf(5) != -1){  //if 5 is in list let check is true
            check = true;
        }
        ...
        check = true; // Fix this
        if(list.indexOf(6) == -1){  //if 6 isn't in list let check is false
            check = false;
        }
        ...
        // Fix all of these
        for(Integer e : list){  //let e go in list 
            System.out.print(e + ", "); //print all element in list
        }
        System.out.println();
    }
    ...
    public static void arrayOfListTest(){
        ...
        for (int i=0; i<arr.length; i++){   
            ...
            for(String e : arr[i]){ //go to each list
                System.out.print(e + ", "); //print all element in list
            }
            System.out.println();
        }
        ...
        for (int i=0; i<arr.length; i++){
            ...
            // Do something
            boolean check = false;  
            if(arr[i].indexOf("Benjamin") != -1){   //if Benjamin is in list
                check = true;
            }
